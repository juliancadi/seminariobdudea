function refresh(id, ref)
{
	...
	objeto.open('GET', "com/sembd/industriasaj/view/listarProductos/listarProductosReport.jsp?ref="+ref,true); // indicamos con el método open la url a cargar de manera asíncrona
