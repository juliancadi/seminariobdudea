...
<div id="container">
  <div id="mainContent">
    <h1 align="center">Consultar Pedidos y Entregas</h1>
    <form id="form1" name="form1" method="post" action="">
    <span id="spryselect1">
        <label><span style="font-weight: bold;">Producto:</span>
          <select name="lista_productos" id="lista_productos" onchange="javascript:Carga('com/sembd/industriasaj/view/consultarPedEnt/consultarPedEntReport.jsp?ref='+this.value,'informacion');">
